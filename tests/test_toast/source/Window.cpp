...
{
    durationSpinBox->setValue((reason+1)*10);
    switch (reason) {
...
void Window::showMessage()
{
    ...
    //trayIcon->activated(QSystemTrayIcon::ActivationReason(activationReason->value()));
...
/*
    activationReason = new QSpinBox;
    activationReason->setMinimum(0);
    activationReason->setMaximum(4);
    activationReason->setValue(3);
    iconLayout->addWidget(activationReason);*/
}
