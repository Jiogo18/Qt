...
public:
    ...
    static bool isPrimeNumber(uintBig nb);
    static bool arePrime(uintBig nb1, uintBig b);
    ...
    static uintBig InverseBModuloN(uintBig b, uintBig n);
    static uintBig chiffrer(uintBig msg, uintBig d_e, uintBig n, QProgressBar *ch=new QProgressBar);
};
